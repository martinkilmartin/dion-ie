export const APP_TITLE = 'díon.ie'
export const BASE_URL = 'dion.ie'
export const BRAND = 'díon.ie'
export const TAG_LINE = 'Everyone deserves a roof over their head'
export const HERO_IMG = '@img/bg/coastal-cottage-the-burren-clare.jpg'
...
export const CONTACT_EMAIL_SUBJECT = 'díon.ie Enquiry'
